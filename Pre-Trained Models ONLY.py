...
# First define the MonaiUNetWrapper class before it's used
...
# Then define the train_model function
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for inputs, masks in dataloaders[phase]:
                ...
                preds = torch.sigmoid(out[:, 1]).cpu().detach().numpy()  # Probability of class 1
            ...
            # Calculate precision, recall using logical operations
            ...
            if phase == 'val' and map50 > best_iou:
                best_iou = map50
